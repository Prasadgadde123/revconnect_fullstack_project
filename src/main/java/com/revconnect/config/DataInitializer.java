...
public class DataInitializer implements CommandLineRunner {
        ...
        public void run(String... args) {
                ...
                createPost(business, "Introducing our NEW Summer Collection! Shop now 🌊", "new,summer,fashion,premium", PostType.PROMOTIONAL);

                // Targeted posts
                createPost(creator, "Innovation is not just about technology; it's about a new way of seeing the world. 💡", "innovation,tech,future", PostType.REGULAR);
                createPost(alice, "Obsessed with the new #lavender theme on RevConnect! It looks so premium. ✨", "lavender,revconnect,premium", PostType.REGULAR);
                createPost(bob, "RevConnect is changing the game for social media. Clean UI, great features! 🚀", "revconnect,socialmedia,ux", PostType.REGULAR);

                createPost(business, "Scale your business effortlessly with our new SaaS integration tools. 📈", "saas,business,productivity", PostType.PROMOTIONAL);

                createPost(creator, "The future of social media is here. Connect deeply, create freely. 🌐", "socialmedia,innovation,revconnect", PostType.REGULAR);
                ...
                try {
                        ...
                        var req3 = connectionService.sendRequest(bob, carol);
